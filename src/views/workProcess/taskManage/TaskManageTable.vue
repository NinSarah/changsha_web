  ...
  <div>
    <el-row :gutter="10" class="result">
      ...
      <el-col :span="1.5" style="float: right;">
        ...
        <el-button type="danger" icon="el-icon-delete" size="small" :disabled="multiple" @click="deleteEquipment">批量删除
        </el-button>
      </el-col>
    </el-row>

    <el-table v-loading="loading" :data="tableList" @selection-change="handleSelectionChange" style="width: 100%;" border  height="400">
      ...
      <el-table-column label="任务详情"  width="110" >
        <template slot-scope="scope">
          <a href="javascript:;" style="color: green;cursor: pointer;"  @click="detail(scope.row)">查看详情</a>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width"  fixed="right" width="280">
        <template slot-scope="scope">
          <el-button type="success" size="small" icon="el-icon-edit" plain @click="editTaskManage(scope.row)" />
          <el-button
            size="small"
            type="danger"
            icon="el-icon-delete"
